            ...
            @foreach ($employees as $employee)
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-primary button_qr mt-2" data-id="{{ $employee->id }}" data-bs-toggle="modal" data-bs-target="#qrModal"><i class="fas fa-exclamation-triangle"></i></button>
                    </td>
                </tr>
            @endforeach
            </tbody>
